const experiences = [
    {
        ...
        company: "Ayahtek",
        description: "Design and Design adn Design",
    ...
    },
    {
        ...
        description: "Built and Learn the excel pivot etc",
...
export const Experience  = () => {
    return  (
        ...
        >
            <div
            className="absolute top-1/2 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 "></div>
            <div className="container mx-auto relative px-6 z-10">
                ...
                <div className="max-w-3xl mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-primary  mt-4 mb-6 leading-tight animate-fade-in glow-text">Experience 
                        <span className="font-serif font-normal text-secondary-foreground"> that speak bebe.</span>
                    </h2>
                    <p className="text-muted-foreground animate-fade-in animation-delay-100"> Hakdog didigidog digidog</p>
                </div>
                {/* Timeline */}
                <div className="relative">
                    ...
                    md:-translate-x-1/2 shadow-[0_0_25px_rgba(32,178,166,0.)]" />
                        ...
                        style = {{animationDelay: `${(idx + 1) * 100}ms`}}>
                            ...
                            <div className={`pl-8 md:pl-0 ${idx % 2 === 0 
                                ...
                                <div className={`glass p-6 rounded-2xl border border-primary/30 
                                    ...
                                    ? "md:justify-end" : ""}`}>{exp.technologies.map((tech, techIdx) =>(
                                            <span 
                                            key = {techIdx}
